...
import com.ashzd.blog.service.TagService;
import com.ashzd.blog.service.UserService;
...
public class IndexController {
    ...
    public String index(Model model){
        ...
        for (String category: BlogUtil.categorys){
            String categoryKey = RedisKeyUntil.getCategoryKey(category);
            String num = jedisService.get(categoryKey);
            if (num!=null)
                categoryCount.set(BlogUtil.categoryMap.get(category),num);
            else
                categoryCount.set(BlogUtil.categoryMap.get(category),0);
        }
